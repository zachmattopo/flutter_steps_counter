...
/// Provides a lower bound (always 1.0) and upper bound
/// to the system `textScaleFactor`, allowing the users to
/// control the text size without going completely overboard.
///
